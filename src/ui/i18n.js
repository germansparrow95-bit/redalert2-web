...
(function (RA) {
  ...
  var STRINGS = {
    zh: {
      ...
      'help.economyRows': [
        ...
        ['建造厂', '负责建造建筑；放置时只要在基地 5 格范围内即可，不必紧贴。'],
      ...
      'reason.tooFar': '超出基地范围（只能建在离基地 {n} 格以内）',
    ...
    en: {
      ...
      'help.economyRows': [
        ...
        ['Construction Yard', 'Builds structures; place them anywhere within 5 tiles of your base.'],
      ...
      'reason.tooFar': 'Outside your base area (place it within {n} tiles of your base)',
  ...
  I18n.reason = function (result) {
    ...
    if (result.reasonKey) {
      ...
      if (result.reasonKey === 'tooFar') params.n = RA.Rules.BUILD_RADIUS;
